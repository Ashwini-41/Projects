...
public class Home extends Application {
    ...
    Scene start_0(){
        ...
        i1.setStyle("-fx-font-size:40px;-fx-fontFamily:Copperplate Gothic Bold;-fx-font-:white;-fx-Height:213;-fx-width:40 ;-fx-align:CENTER");
       ...
       // v1.setAlignment(Pos.TOP_LEFT);
        ...
        HBox hb_cal_1 =new HBox(new Label("Scientific Calculator"));
        ...
        btn_sci.setStyle("-fx-alignment: CENTER;-fx-font-size:18px;-fx-pref-height:54;-fx-pref-width:249; -fx-background-color:green;-fx-text-fill:white");
        ...
        btn_todo.setStyle("-fx-alignment: CENTER;-fx-font-size:18px;-fx-pref-height:54;-fx-pref-width:249; -fx-background-color:green; -fx-text-fill:white");
        VBox vb_todolist=new VBox(hb_todo_1,hb_todo_2,btn_todo);


        HBox hb_quize_1 =new HBox(new Label("Quiz App"));
        ...
        btn_quize.setStyle("-fx-alignment: CENTER;-fx-font-size:18px;-fx-pref-height:54;-fx-pref-width:249; -fx-background-color:green; -fx-text-fill:white");
