...
public class Prasad extends Application {

    private TextField concentrationField;

    private Label welcomeUsername, reports, ourInfo,periodicTableInfo, titleLabel, concentrationLabel, resultLabel, pHValueLabel, steps,
            theory1, theory2, theory3, theory4, theory5,aboutUsLaabel,teamMemLabel,teamMemberNameLabel,comminSoonLAbel;
    private AnchorPane root;
    public AnchorPane profileAnchorePane, profileSideAnchorePane, graphAnchorePane, pagesAnchorPane;
    private Button Dashboard, anyalasisButton, ourteamButton, abouC2WButton, loginOutButton, periodicTableButton, phCalculator,
    ...
    private ImageView c2wLogo, profileLogo, elementalTextLogo, profileSideAnchorePaneLogo, phCalculationLogo,
            backButtonLogo, phScaleImage, phcalculationbackgroundimage, button1logo, aboutc2wimage, c2wBackGround,ourInfoImage,
    ...
    public void start(Stage primaryStage) {
        ...
        homepagebackground.setFitWidth(1200);
        homepagebackground.setFitHeight(900);
        ...
        phCalculationLogo.setFitWidth(540);
        phCalculationLogo.setFitHeight(190);
        ...
        AnchorPane.setLeftAnchor(elementalTextLogo, 55.0);
        AnchorPane.setTopAnchor(elementalTextLogo, 60.0);

        welcomeUsername = new Label("username");

        welcomeUsername.setPrefHeight(30.0);
        ...
        // Dashboard.setStyle("-fx-background-radius: 15px; #9E7BFF;-fx-padding: 10px 20px;");
        ...
        anyalasisButton.setPrefHeight(40.0);
        anyalasisButton.setPrefWidth(205.0);
        ...
        ourteamButton.setPrefHeight(40.0);
        ourteamButton.setPrefWidth(205.0);
        ...
        ourteamButton.setOnAction(event -> {
            ...
            profileSideAnchorePane.getChildren().clear();
            profileSideAnchorePane.getChildren().addAll(ourInfoImage,aboutUsLaabel,teamMemLabel,teamMemberNameLabel,backButton);
        ...
        abouC2WButton.setPrefHeight(40.0);
        abouC2WButton.setPrefWidth(205.0);
        ...
        teamMemLabel.setStyle("-fx-background-radius: 30px; -fx-padding: 10px 20px; -fx-background-color: #FFFF;-fx-font-weight:bold; ");
        ...
        teamMemberNameLabel.setStyle("-fx-background-radius: 30px; -fx-padding: 10px 20px; -fx-background-color: #FFFF;-fx-font-weight:bold; ");
    ...
    private void login() throws IOException {
        ...
        backGround.setFitHeight(850);
        backGround.setFitWidth(1650);
        ...
        login.setOnAction(event -> {
            ...
            try (InputStream input = new FileInputStream(
                    "C:\\VS code programs\\Java Project\\chemProject\\LoginInfo.properties")) {
            ...
            if (storedPassword != null && storedPassword.equals(password)) {
                ...
                try (InputStream input = new FileInputStream(
                        "C:\\VS code programs\\Java Project\\chemProject\\currectQuizuizeInfo.properties")) {
                ...
                try {
                    ...
                    profileLogo = new ImageView("ProfilePhotos/profileLogo.png");
    ...
    private void dashboardInterface() {
        ...
        profileSideAnchorePane.getChildren().addAll(profileSideAnchorePaneLogo,
                /* homepagebackground, */ graphAnchorePane, elementalTextLogo, periodicTableButton, phCalculator, equationbalanceButton, simulatorButton, theroryButton, quizButtom,reports);

    }

    private void ourInfo() {

        profileSideAnchorePane.getChildren().addAll(ourInfo);
    ...
    void quizInterface() {
        ...
        layout.setStyle("-fx-background-image: url('Chem2.jpg'); " + "-fx-background-size: cover;");
    ...
    void quizCalculation() {
        ...
        try (InputStream input = new FileInputStream(
                "C:\\Users\\HP\\OneDrive\\Desktop\\chemProject\\currectQuizuizeInfo.properties")) {
            properties.load(input);
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            // Change the value of a pre-existing key
            properties.setProperty(username, currectQuizString);

            // Save the changes back to the properties file
            FileOutputStream output = new FileOutputStream(
                    "C:\\\\Users\\\\HP\\\\OneDrive\\\\Desktop\\\\chemProject\\\\currectQuizuizeInfo.properties");
            properties.store(output, "Updated properties");
            output.close();

            // System.out.println("Value changed and data written to properties file
            // successfully.");
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    initialConcentrationC = 0.0;
     ...
     double time = 0.0;
        ...
        temAnchorPane.setPrefWidth(1700);
        temAnchorPane.setPrefHeight(900);
   ...
   // Set a background image
        Image backgroundImage = new Image("Chem2.jpg");
        ImageView backgroundView = new ImageView(backgroundImage);
        backgroundView.setFitHeight(990);
            backgroundView.setFitWidth(1700);
